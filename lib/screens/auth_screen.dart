          ...
          Container(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [
                  const Color.fromRGBO(227, 221, 5, 1.0),
...
class _AuthCardState extends State<AuthCard>
  ...
  Animation<Size> _animatedHeight;
  ...
  void initState() {
    ...
    _animatedHeight = Tween<Size>(
            begin: Size(double.infinity, 300), end: Size(double.infinity, 320))
        .animate(
      CurvedAnimation(
        parent: _controller,
        curve: Curves.linear,
    ...
    _animatedOpacity = Tween<double>(begin: 0, end: 1).animate(
      CurvedAnimation(
        parent: _controller,
        curve: Curves.easeIn,
      ),
